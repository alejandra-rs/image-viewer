...
* **Lazy Loading**: High-resolution images are loaded from the disk only when strictly required for display, rather than pre-loading the entire directory into memory. This optimizes memory usage and startup time.
